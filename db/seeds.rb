...
Profile.create(
  ...
  text_three: "The internet explodes! We are excited and hurt all over again. Hashtags #TheySilencedYou, #TheySilencedUs, #TheySilencedThem start trending on Twitter. The change is blamed on a rogue translator, and someone says it was never in the script. Professional translators weigh in on the controversy and disagree with the official story",
