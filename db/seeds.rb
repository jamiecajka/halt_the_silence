...
Profile.create(
  ...
  text_two: 'Then, Warner Brothers LatAm releases the Spanish dub of Supernatural''s ""Despair”. In it, after Castiel says “te amo” (a romantic “I love you”), Dean Winchester doesn’t say “don’t do this”, like in the U.S. version, he instead says "Y Yo a ti, Cas" ("And I, you, Cas").',
  text_three: "The internet explodes! We are excited and hurt all over again. Hashtags #TheySilencedYou, #TheySilencedUs, #TheySilencedThem start trending on Twitter. The change is blamed on a a ""rogue translator"" from the Latin American translation team, and someone says it was never in the script. Professional translators weigh in on the controversy and disagree with the official story",
